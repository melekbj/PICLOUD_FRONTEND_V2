...
export class BehaviorScoreService {
  private baseUrl = 'http://localhost:8080/api/behaviorscore';
  ...
  updateBehaviorScore(behaviorScore: BehaviorScore): Observable<BehaviorScore> {
    return this.http.put<BehaviorScore>(`${this.baseUrl}/update`, behaviorScore);
  }
  ...
  getBehaviorScoresByDateRange(date1: Date, date2: Date): Observable<BehaviorScore[]> {
    return this.http.get<BehaviorScore[]>(`${this.baseUrl}/getByDateRange?date1=${date1}&date2=${date2}`);
  }
  addBehaviorScoreBasedOnMembership(idUser: number, idClub: number, behaviorScore: BehaviorScore): Observable<BehaviorScore> {
    return this.http.post<BehaviorScore>(`${this.baseUrl}/addBehaviorScorebasedonMembership/${idUser}/${idClub}`, behaviorScore);
  }
  getBehaviorScoresByMembership(id: number): Observable<BehaviorScore[]> {
    return this.http.get<BehaviorScore[]>(`${this.baseUrl}/getByMembership/${id}`);
  }
}
