...
export class DepartmentService {
  private apiUrl = 'http://localhost:8089/api/department'; 
  ...
  addDepartment(department: Department,idclub : number , iduser : number): Observable<Department> {
    return this.http.put<Department>(`${this.apiUrl}/create/${idclub}/${iduser}`, department);
  }
